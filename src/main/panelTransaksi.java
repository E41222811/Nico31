...
public class panelTransaksi extends javax.swing.JPanel {
    ...
    private void autoNumber() {
        ...
        while (result.next()){
            if (result.first()== false){
                fieldIDTransaksi.setText("TR/" + Tgl + "/" + "0001");
            }else{
                result.last();
                ...
                fieldIDTransaksi.setText("TR/" + Tgl + "/" + No);
                }
            }
        }
        catch(Exception e){
    ...
    private void initComponents() {
        ...
        fieldHargaTransaksi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fieldHargaTransaksiActionPerformed(evt);
            }
        });
        ...
        fieldPendapatanHariIniTransaksi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fieldPendapatanHariIniTransaksiActionPerformed(evt);
            }
        });
        ...
        add(button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 10, 100, 50));
...
//        }
    ...
    private void fieldPendapatanHariIniTransaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fieldPendapatanHariIniTransaksiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fieldPendapatanHariIniTransaksiActionPerformed

    private void fieldHargaTransaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fieldHargaTransaksiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fieldHargaTransaksiActionPerformed
