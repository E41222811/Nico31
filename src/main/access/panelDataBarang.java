...
public class panelDataBarang extends javax.swing.JPanel {
    ...
    private void autoNumberDataBarang(){
        ...
        if(result.next()){
            ...
            fieldIDDataBarang.setText("BR" + Nol + AN);    
        } else {
            fieldIDDataBarang.setText("BR001");
        }
...
//        } 
    ...
    private void tableDataBarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDataBarangMouseClicked
        ...
        fieldIDDataBarang.setText(tableDataBarang.getValueAt(tableDataBarang.getSelectedRow(),0)+"");
        fieldNamaDataBarang.setText(tableDataBarang.getValueAt(tableDataBarang.getSelectedRow(),1)+"");
        fieldKategoriDataBarang.setText(tableDataBarang.getValueAt(tableDataBarang.getSelectedRow(),2)+"");
        fieldUkuranDataBarang.setText(tableDataBarang.getValueAt(tableDataBarang.getSelectedRow(),3)+"");
        fieldHargaDataBarang.setText(tableDataBarang.getValueAt(tableDataBarang.getSelectedRow(),4)+"");
        //fieldTanggalDataPembelian.setText(tableDataPembelian.getValueAt(tableDataPembelian.getSelectedRow(),5)+"");
        
        buttonEditDataBarang.setEnabled(true);
        buttonHapusDataBarang.setEnabled(true);
