...
//        }
    ...
    private void buttonSimpanDataBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSimpanDataBarangActionPerformed
        ...
        String Tanggal = fieldTanggalDataPembelian.getText();
...
//            try{
//                Statement statement = (Statement) service.connect.GetConnection().createStatement();
//                statement.executeUpdate("INSERT INTO data_pembelian(id_pembelian,id_supplier,tanggal_pembelian,harga_beli,quantity) VALUES ('" + IDPembelian + "', '"+ IDSupplier +"', '"+ IDKategori +"', '"+ Tanggal +"', '" + Harga +"', '" + Quantity +"');");
//                statement.close ();
//                resetDataPembelian();
//            }catch (Exception t){
...
try {
            ...
            ("insert into data_pembelian (id_pembelian, id_supplier, id_kategori, tanggal_pembelian, harga_beli, quantity) values" + "('" + fieldIDDataPembelian.getText() + "',"
                    + "'" + fieldSupplierDataPembelian.getText() + "','" + fieldKategoriDataPembelian.getText() + "',"
                    + "'" + fieldTanggalDataPembelian.getText() + "','"+fieldHargaDataPembelian.getText()+"','" + fieldQuantityDataPembelian.getText() + "')");
           
            //{"Id Pengeluaran", "Tanggal", "Nama Pengeluaran", "Nominal","Pengguna"}
        } catch (SQLException ex) {
            Logger.getLogger(panelDataPembelian.class.getName()).log(Level.SEVERE, null, ex);
        }
