...
public class panelDataSupplier extends javax.swing.JPanel {
        ...
        Statement statement = (Statement)service.connect.GetConnection().createStatement();
            ...
            if(result.next()){
                ...
                if(AND.length()==1)
                    ...
                    {Nol="0";}
                fieldIDSupplier.setText("SP" + Nol + AND);
                
            } else {
                fieldIDSupplier.setText("SP01");
            }
    ...
    private void initComponents() {
        ...
        fieldIDSupplier.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fieldIDSupplierActionPerformed(evt);
            }
        });
    ...
    private void fieldIDSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fieldIDSupplierActionPerformed
        // TODO add your handling code here:
        autoNumberDataSupplier();
    }//GEN-LAST:event_fieldIDSupplierActionPerformed
