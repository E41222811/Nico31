...
public class panelLogin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, -1, 340));
        ...
        add(panelTransparent1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 720, 370));
            ...
            if(rest.next())
            {
                if(fieldPassword.getText().equals(rest.getString("password"))){
                    ...
                    if(rest.getString("tipe_akun").equals("Administrator")){
                        ...
                        homeUser.repaint();
                        homeUser.revalidate();
                        main.panelHome.labelProfileHome.setText("Selamat Datang,"+rest.getString(2));
                        main.panelHome.labelTipeAkun.setText("Administrator");
                    } else {
                        homeUser.removeAll();
                        ...
                        homeUser.revalidate();
                        main.panelHome.labelProfileHome.setText("Selamat Datang,"+rest.getString(2));
                        main.panelHome.labelTipeAkun.setText("Karyawan");
                    }
