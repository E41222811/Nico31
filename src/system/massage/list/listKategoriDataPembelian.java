...
public class listKategoriDataPembelian extends javax.swing.JFrame {

    
    public listKategoriDataPembelian() {
        initComponents();
    ...
    private void pilihListKategori(){
        ...
        main.access.panelDataPembelian.fieldKategoriDataPembelian.setText(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listKategoriDataPembelian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listKategoriDataPembelian().setVisible(true);
            }
        });
    }
